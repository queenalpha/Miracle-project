        ...
        <div class="modal-body">
          <?php if (isset($_SESSION['logged_in'])) { ?>
            <div class="form-group">
              <div class="row">
                <div class="col">
                  <div class="row gy-2">
                    <div>
                      <input type="radio" class="btn-check" name="amount" id="o-1" value="10000" autocomplete="off"
                        checked>
                      <label class="btn btn-secondary w-100" for="o-1">Rp. 10.000,-</label>
                    </div>
                    <div>
                      <input type="radio" class="btn-check" name="amount" id="o-2" value="25000" autocomplete="off">
                      <label class="btn btn-secondary w-100" for="o-2">Rp. 25.000,-</label>
                    </div>
                    <div>
                      <input type="radio" class="btn-check" name="amount" id="o-3" value="50000" autocomplete="off">
                      <label class="btn btn-secondary w-100" for="o-3">Rp. 50.000,-</label>
                    </div>
                    <div>
                      <input type="radio" class="btn-check" name="amount" id="o-4" value="75000" autocomplete="off">
                      <label class="btn btn-secondary w-100" for="o-4">Rp. 75.000,-</label>
                    </div>
                    <div>
                      <input type="radio" class="btn-check" name="amount" id="o-5" value="100000" autocomplete="off">
                ...
                <div class="col">
                  <div class="row gy-2">
                    <div class="col col-md-12 col-lg-6">
                      <input type="radio" class="btn-check" name="payment" id="p-1" value="GoPay" autocomplete="off"
                        checked>
                      <label class="btn btn-secondary w-100" for="p-1">GoPay</label>
                    </div>
                    <div class="col col-md-12 col-lg-6">
                      <input type="radio" class="btn-check" name="payment" id="p-2" value="Shopeepay" autocomplete="off">
                      <label class="btn btn-secondary w-100" for="p-2">LinkAja</label>
                    </div>
                    <div class="col col-md-12 col-lg-6">
                      <input type="radio" class="btn-check" name="payment" id="p-3" value="DANA" autocomplete="off">
                      <label class="btn btn-secondary w-100" for="p-3">DANA</label>
                    </div>
                    <div class="col col-md-12 col-lg-6">
                      <input type="radio" class="btn-check" name="payment" id="p-4" value="OVO" autocomplete="off">
                      <label class="btn btn-secondary w-100" for="p-4">OVO</label>
                    </div>
                    <div class="col col-md-12 col-lg-6">
                      <input type="radio" class="btn-check" name="payment" id="p-5" value="BCA" autocomplete="off">
                      <label class="btn btn-secondary w-100" for="p-5">BCA</label>
                    </div>
                    <div class="col col-md-12 col-lg-6">
                      <input type="radio" class="btn-check" name="payment" id="p-6" value="Mandiri" autocomplete="off">
                      <label class="btn btn-secondary w-100" for="p-6">Mandiri</label>
                    </div>
                    <div class="col col-md-12 col-lg-6">
                      <input type="radio" class="btn-check" name="payment" id="p-7" value="Jago" autocomplete="off">
            ...
            <div class="form-group">
              <div class="row gy-2">
                <div>
                  <input type="radio" class="btn-check" name="amount" id="o-1" value="10000" autocomplete="off" checked>
                  <label class="btn btn-secondary w-100" for="o-1">Rp. 10.000,-</label>
                </div>
                <div>
                  <input type="radio" class="btn-check" name="amount" id="o-2" value="25000" autocomplete="off">
